<ul style="list-style-type: none; padding-inline-start:0px;">
    ...
    <li>
        <a class="font-weight-bold mb-4 d-inline-block" style="color:#1d68a7; font-size: medium" href="#">Notification</a>
    </li>
    <li>
    ...
    <li>
        <a class="font-weight-bold mb-4 d-inline-block" style="color:#1d68a7; font-size: medium" href="#">Profile</a>
    </li>
</ul>
